...
# Ensure Tang never writes its cache files to a durable location
echo 'tmpfs /var/cache/tang   tmpfs  nodev,nosuid            0 0' >> /etc/fstab
...
tmpfs /var/cache/tang   tmpfs  nodev,nosuid            0 0
